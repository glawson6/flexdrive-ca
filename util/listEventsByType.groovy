...
if (args.length > 0) {
    ...
    //String operationURL = "https://${apiHost}:443/events/subscriber/${args[0]}/?startTime=2015-10-26T22:06:42.188Z&endTime=2015-10-30T22:06:42.188Z";
    String operationURL = "https://${getAPIHost()}:443/events/type/${args[0]}";
    ...
    throw new IllegalArgumentException("Must pass an event type!");
}
