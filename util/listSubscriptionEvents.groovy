...
if (args.length > 0) {
    ...
    String operationURL = "https://${getAPIHost()}:443/events/subscription/${args[0]}/?startTime=2015-10-26T22:06:42.188Z&endTime=2015-12-30T22:06:42.188Z";
    ...
    throw new IllegalArgumentException("Must pass a subscription id!");
}
